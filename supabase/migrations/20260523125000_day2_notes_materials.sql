...
begin
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'notes'
      and policyname = 'notes select own'
  ) then
...
begin
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'notes'
      and policyname = 'notes insert own'
  ) then
...
begin
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'notes'
      and policyname = 'notes update own'
  ) then
...
begin
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'notes'
      and policyname = 'notes delete own'
  ) then
...
begin
  if not exists (
    ...
    where schemaname = 'public'
      ...
      and policyname = 'study_materials select own'
  ) then
...
begin
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'study_materials'
      and policyname = 'study_materials insert own'
  ) then
...
begin
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'study_materials'
      and policyname = 'study_materials update own'
  ) then
...
begin
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'study_materials'
      and policyname = 'study_materials delete own'
  ) then
