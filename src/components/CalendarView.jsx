...
const calS = {
  ...
  mobileToolbar: { width:'100%', overflowX:'auto', paddingBottom:4, scrollbarWidth:'none', WebkitOverflowScrolling:'touch' },
  ...
  mobileCatsRow: { flexWrap:'nowrap', overflowX:'auto', margin:'0 -14px', padding:'0 14px 6px', scrollbarWidth:'none', WebkitOverflowScrolling:'touch' },
  ...
  mobileDayRail: { display:'grid', gridAutoFlow:'column', gridAutoColumns:'76px', gap:9, overflowX:'auto', margin:'0 -14px', padding:'2px 14px 6px', scrollbarWidth:'none', WebkitOverflowScrolling:'touch', scrollSnapType:'x proximity' },
  mobileDayButton: { minHeight:96, minWidth:76, borderRadius:20, border:'1px solid var(--border)', background:'var(--surface)', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap:6, cursor:'pointer', padding:'9px 7px', scrollSnapAlign:'start', WebkitTapHighlightColor:'transparent' },
