...
const s = {
  ...
  hero: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 24, borderRadius: 30, background: 'linear-gradient(145deg,#4C3BFF 0%,#8E75FF 58%,#BDA5FF 100%)', color: '#fff', border: '1px solid rgba(255,255,255,.26)', boxShadow: '22px 26px 54px rgba(76,59,255,.26), -12px -12px 28px rgba(255,255,255,.62), inset 0 1px 0 rgba(255,255,255,.32)' },
  ...
  heroButton: { border: '1px solid rgba(255,255,255,.78)', borderRadius: 16, background: 'linear-gradient(145deg,#FFFFFF,#F2EDFF)', color: '#4C3BFF', padding: '12px 18px', fontWeight: 850, cursor: 'pointer', boxShadow: '12px 14px 28px rgba(47,35,136,.18), inset 0 1px 0 rgba(255,255,255,.9)' },
  heroPill: { display: 'inline-flex', alignItems: 'center', gap: 8, border: '1px solid rgba(255,255,255,.32)', borderRadius: 999, color: '#fff', background: 'rgba(255,255,255,.16)', padding: '9px 13px', fontWeight: 750, maxWidth: '100%', boxShadow: 'inset 0 1px 0 rgba(255,255,255,.24)' },
  ...
  panel: { background: 'var(--clay-surface)', border: '1px solid rgba(255,255,255,.74)', borderRadius: 26, padding: 18, boxShadow: 'var(--clay-shadow), var(--clay-highlight)', minWidth: 0 },
  ...
  countBadge: { borderRadius: 999, background: 'linear-gradient(145deg,#FFFFFF,#EFE9FF)', color: 'var(--indigo)', padding: '6px 10px', fontSize: 12, fontWeight: 850, whiteSpace: 'nowrap', boxShadow: 'var(--clay-shadow-sm)' },
  scheduleList: { display: 'grid', gap: 8 },
  scheduleItem: { display: 'flex', alignItems: 'center', gap: 12, width: '100%', border: '1px solid rgba(255,255,255,.66)', borderRadius: 18, padding: '11px 12px', cursor: 'pointer', textAlign: 'left', minWidth: 0, boxShadow: 'var(--clay-shadow-sm)' },
  ...
  quickAction: { minHeight: 82, border: '1px solid rgba(255,255,255,.72)', borderRadius: 20, background: 'linear-gradient(145deg,#FFFFFF,#F7F1FF)', padding: 12, display: 'grid', justifyItems: 'start', alignContent: 'space-between', color: '#171733', cursor: 'pointer', textAlign: 'left', boxShadow: 'var(--clay-shadow-sm)' },
  iconTile: { width: 36, height: 36, borderRadius: 14, display: 'inline-grid', placeItems: 'center', flex: '0 0 auto', boxShadow: 'inset 0 1px 0 rgba(255,255,255,.7)' },
  ...
  primaryButton: { border: '1px solid rgba(255,255,255,.34)', borderRadius: 16, background: 'linear-gradient(145deg,var(--indigo),var(--purple))', color: '#fff', padding: '12px 16px', fontWeight: 850, cursor: 'pointer', width: '100%', boxShadow: '12px 16px 30px -18px rgba(76,59,255,.78), inset 0 1px 0 rgba(255,255,255,.22)' },
  outlineButton: { border: '1px solid rgba(255,255,255,.72)', borderRadius: 16, background: 'linear-gradient(145deg,#FFFFFF,#F0EAFF)', color: '#6D5DF6', padding: '12px 16px', fontWeight: 850, cursor: 'pointer', width: '100%', boxShadow: 'var(--clay-shadow-sm)' },
  softButton: { border: '1px solid rgba(255,255,255,.72)', borderRadius: 16, background: 'linear-gradient(145deg,#FFFFFF,#F8F4FF)', color: '#777C90', padding: '12px 16px', fontWeight: 800, cursor: 'pointer', width: '100%', marginTop: 8, boxShadow: 'var(--clay-shadow-sm)' },
  ...
  modal: { width: 'min(340px, 100%)', background: 'var(--clay-surface)', border: '1px solid rgba(255,255,255,.76)', borderRadius: 28, padding: 24, display: 'grid', justifyItems: 'center', gap: 10, boxShadow: 'var(--clay-shadow)' },
