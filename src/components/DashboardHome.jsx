...
const s = {
  ...
  empty: { minHeight: 162, display: 'grid', gridTemplateRows: 'auto minmax(44px, auto) auto', justifyItems: 'center', alignContent: 'center', gap: 10, textAlign: 'center', color: '#777C90', background: '#FAFBFF', borderRadius: 14, padding: 18 },
  emptyTitle: { color: '#777C90', fontSize: 16, lineHeight: 1.25, fontWeight: 850 },
  emptyText: { maxWidth: 520, minHeight: 44, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#777C90', fontSize: 15, lineHeight: 1.35, fontWeight: 650 },
  emptyAction: { minHeight: 38, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 6, border: '1px solid #D8DCFF', borderRadius: 999, background: '#fff', color: '#3730E8', padding: '0 14px', fontSize: 13, fontWeight: 850, cursor: 'pointer' },
