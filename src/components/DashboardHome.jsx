...
const s = {
  ...
  emptyAction: { marginTop: 8, minHeight: 38, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 6, border: '1px solid #D8DCFF', borderRadius: 999, background: '#fff', color: '#3730E8', padding: '0 14px', fontSize: 13, fontWeight: 850, cursor: 'pointer' },
