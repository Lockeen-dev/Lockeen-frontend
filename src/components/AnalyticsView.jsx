...
const analS = {
  noticeCard: { background:'var(--clay-surface)', border:'1px solid rgba(255,255,255,.74)', borderRadius:20, padding:16, color:'var(--gray)', fontSize:14, boxShadow:'var(--clay-shadow-sm)' },
  dataPill: { display:'inline-flex', alignItems:'center', border:'1px solid rgba(255,255,255,.74)', background:'linear-gradient(145deg,#FFFFFF,#F3EEFF)', color:'var(--gray)', borderRadius:999, padding:'8px 11px', fontSize:12, fontWeight:800, boxShadow:'var(--clay-shadow-sm)' },
  statsGrid: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14, marginBottom: 22 },
  kpiCard: { borderRadius: 24, padding: '18px 20px', display: 'flex', flexDirection: 'column', boxShadow:'var(--clay-shadow-sm)', border:'1px solid rgba(255,255,255,.56)' },
  statCard: { display: 'flex', alignItems: 'center', gap: 12, padding: 16, background: 'var(--clay-surface)', border: '1px solid rgba(255,255,255,.74)', borderRadius: 22, boxShadow:'var(--clay-shadow-sm)' },
  ...
  chartCard: { background: 'var(--clay-surface)', border: '1px solid rgba(255,255,255,.74)', borderRadius: 28, padding: 22, boxShadow:'var(--clay-shadow), var(--clay-highlight)' },
  ...
  subjectCard: { background: 'var(--clay-surface)', border: '1px solid rgba(255,255,255,.74)', borderRadius: 28, padding: 22, boxShadow:'var(--clay-shadow), var(--clay-highlight)' },
  ...
  gradeList: { border: '1px solid rgba(255,255,255,.74)', borderRadius: 28, background: 'var(--clay-surface)', overflow: 'hidden', marginRight: 14, boxShadow:'var(--clay-shadow), var(--clay-highlight)' },
  ...
  practiceBtn: { justifySelf: 'end', minWidth: 128, maxWidth: '100%', padding: '11px 12px', borderRadius: 16, border: '1px solid rgba(255,255,255,.74)', background: 'linear-gradient(145deg,#FFFFFF,#F2ECFF)', color: 'var(--ink)', fontSize: 12, fontWeight: 900, whiteSpace: 'nowrap', cursor: 'pointer', boxShadow:'var(--clay-shadow-sm)' },
