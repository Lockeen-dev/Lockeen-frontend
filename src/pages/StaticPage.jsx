...
const staticPageContentTranslations = {
  ...
  earn: [
    ...
    ['A request-only program for students, class reps, and university creators who want to share Lockeen authentically. Personal link, ready-to-use material, and tracked referrals without turning into walking advertising.', 'Un programma su richiesta per studenti, rappresentanti e creator universitari che vogliono condividere Lockeen in modo autentico. Link personale, materiali pronti e referral tracciati senza trasformarti in pubblicità ambulante.'],
    ...
    ['Verified results, not invented numbers.', 'Risultati verificati, non numeri inventati.'],
    ...
    ['Share only where Lockeen can be useful. We prefer trust and context over copied messages everywhere.', 'condividi solo dove Lockeen può essere utile. Preferiamo fiducia e contesto a messaggi copiati ovunque.'],
    ['Request-only access', 'Accesso su richiesta'],
    ['Apply as a Lockeen Partner.', 'Candidati come Partner Lockeen.'],
    ['Leave your email: we will contact you with program details, your personal link, and guidelines for sharing Lockeen the right way.', 'Lascia la tua email: ti contattiamo noi con i dettagli del programma, il link personale e le linee guida per condividere Lockeen nel modo giusto.'],
    ...
    ['Track referrals', 'Monitora i referral'],
    ['Follow confirmed signups and receive payout when you reach the planned threshold.', 'Segui le iscrizioni confermate e ricevi il payout quando raggiungi la soglia prevista.'],
    ['Campus playbook', 'Playbook campus'],
    ['Where Lockeen is easiest to explain', 'Dove Lockeen si racconta meglio'],
    ['No inflated promises and no invented numbers. Only contexts where an AI study tool can genuinely help.', 'Niente promesse gonfiate e niente numeri inventati. Solo contesti in cui uno strumento di studio AI può davvero servire.'],
    ...
    ['Apply to the Partner Program. If the profile fits, we will send you access, guidelines, and material to start with clean communication.', 'Candidati al Partner Program. Se il profilo è adatto, ti mandiamo accesso, linee guida e materiali per partire con una comunicazione pulita.'],
  ],
  blog: [
