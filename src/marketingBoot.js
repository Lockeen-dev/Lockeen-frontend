export function initMarketingDom() {
  ...
  const LOCKEEN_I18N = {
    en: {
      ...
      'footer.pricing':'Pricing', 'footer.quizzes':'Quizzes', 'footer.about':'About', 'footer.blog':'Blog', 'footer.careers':'Careers', 'footer.earn':'Earn',
      ...
      'footer.rights':'© 2026 Lockeen. All rights reserved.', 'footer.privacyPolicy':'Privacy Policy', 'footer.termsService':'Terms of Service',
    ...
    it: {
      ...
      'footer.pricing':'Prezzi', 'footer.quizzes':'Quiz', 'footer.about':'Chi siamo', 'footer.blog':'Blog', 'footer.careers':'Lavora con noi', 'footer.earn':'Guadagna',
      ...
      'footer.rights':'© 2026 Lockeen. Tutti i diritti riservati.', 'footer.privacyPolicy':'Privacy Policy', 'footer.termsService':'Termini di servizio',
